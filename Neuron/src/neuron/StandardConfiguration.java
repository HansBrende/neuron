...
public class StandardConfiguration extends NeuronConfiguration {
	...
	private static final double dendriteM = (dendriteMaxR - dendriteB)/somaStart;

	private static final double somaR = Util.SOMA_RADIUS;
	private static final double somaR2 = somaR*somaR;
	private static final double somaRx1 = Math.sqrt(somaR2 - dendriteMaxR*dendriteMaxR);
	private static final double somaRx2 = Math.sqrt(somaR2 - Util.AXON_RADIUS*Util.AXON_RADIUS);
	private static final double soma_h = somaStart + somaRx1;
	private static final double axonStart = soma_h + somaRx2;
	private static final double firstSheathStart = axonStart + Util.INITIAL_SEGMENT_LENGTH;
